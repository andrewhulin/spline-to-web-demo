...
export default function Scene({ materialOverrides = {}, onMeshClick, ...props }: SceneProps) {
  ...
  // Helper: resolve material - use override if present, else default
  const mat = (frameName: string, defaultMat: THREE.Material) =>
    materialOverrides[frameName] ?? defaultMat
    ...
    <>
      ...
      <group {...props} dispose={null}>
        <scene name="Scene">
          ...
          {/* === PICTURE FRAMES (clickable, overridable) === */}
          <group name="picture-1" position={[-347.79, -106.98, -808.92]} onClick={handleClick('picture-1')}>
            <mesh
              name="Rectangle2"
              geometry={nodes.Rectangle2.geometry}
              material={mat('picture-1', materials.paper)}
              castShadow
              receiveShadow
          ...
          <group
            ...
            onClick={handleClick('picture-2')}
          >
            <mesh
              name="Rectangle3"
              geometry={nodes.Rectangle3.geometry}
              material={mat('picture-2', materials['red-6'])}
              castShadow
              receiveShadow
          ...
          <group
            ...
            rotation={[-Math.PI / 2, -1.4, -Math.PI / 2]}
            scale={1.16}
            onClick={handleClick('picture-3')}
          >
            <mesh
              name="Rectangle4"
              geometry={nodes.Rectangle4.geometry}
              material={mat('picture-3', materials.paper)}
              castShadow
              receiveShadow
              position={[-0.56, -0.28, 12.36]}
              rotation={[0, 0, -Math.PI / 2]}
          ...
          <group
            ...
            scale={1.13}
            onClick={handleClick('picture-4')}
          >
            <mesh
              name="Rectangle 41"
              geometry={nodes['Rectangle 41'].geometry}
              material={mat('picture-4', materials['red-5'])}
              castShadow
              receiveShadow
          ...
          <group name="picture-5" position={[679.37, 709.51, -857.7]} scale={0.52} onClick={handleClick('picture-5')}>
            <mesh
              name="Rectangle 33"
            ...
            <mesh
              ...
              material={mat('picture-5', materials.paper)}
              castShadow
              receiveShadow
              position={[0, 0, 4.27]}
            />
          </group>
          <group name="picture-6" position={[873.94, 539.96, 676.31]} rotation={[0, -Math.PI / 2, 0]} scale={0.62} onClick={handleClick('picture-6')}>
            <mesh
              name="Rectangle 34"
            ...
            <mesh
              ...
              material={mat('picture-6', materials.paper)}
              castShadow
              receiveShadow
              position={[0, 0, 30.3]}
            />
          </group>
          <group name="picture-7" position={[-603.71, 658.29, -849.62]} onClick={handleClick('picture-7')}>
            <mesh
              name="Ellipse3"
            ...
            <mesh
              ...
              material={mat('picture-7', materials['red-5'])}
              castShadow
              receiveShadow
              position={[0, 0, 2.98]}
              scale={0.94}
          ...
          <group name="picture-8" position={[666.58, 205.46, 370.5]} rotation={[0, -0.17, -0.26]} onClick={handleClick('picture-8')}>
            <mesh
              name="Shape 32"
            ...
            <mesh
              ...
              material={mat('picture-8', materials['Rectangle 23 Material'])}
              castShadow
              receiveShadow
              position={[-9.93, 0, 0]}
              rotation={[0, -Math.PI / 2, 0]}
          ...
          <group name="plant" position={[478.18, 52.43, 781.08]} rotation={[0, 0.4, 0]} scale={0.75}>
            <mesh
              name="Cube 23"
          ...
          <group name="artboard-2" position={[-473.15, 200.52, -517.55]} rotation={[-0.31, -0.59, -0.13]}>
